...
pl.subplot(111)
pl.plot(RES[:,3], '-g', label='Pre-Cancer Cells with vaccination of 0.02999')
...
pl.plot(RES[:,3], '-r', label='Pre-Cancer Cells with vaccination of 0.03999')
...
pl.plot(RES[:,3], '-b', label='Pre-Cancer Cells with vaccination of 0.99691')
...
pl.plot(RES[:,3], '-k', label='Pre-Cancer Cells with vaccination of 0.99692')
