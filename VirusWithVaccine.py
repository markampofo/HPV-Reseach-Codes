...
pl.subplot(111)
pl.plot(RES[:,2], '-g', label='Virus with vaccination of 0.2')
...
pl.plot(RES[:,2], '-r', label='Virus with vaccination of 0.4')
...
pl.plot(RES[:,2], '-b', label='Virus with vaccination of 0.6')
...
pl.plot(RES[:,2], '-k', label='Virus with vaccination of 0.8')
...
pl.plot(RES[:,2], '-y', label='Virus with vaccination of 1')
pl.legend(loc=0)
