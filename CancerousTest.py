...
pl.subplot(111)
pl.plot(RES[:,4], '-g', label='Cancer Cells with vaccination of 0.03999')
...
pl.plot(RES[:,4], '-r', label='Cancer Cells with vaccination of 0.02999')
...
pl.plot(RES[:,4], '-b', label='Cancer Cells with vaccination of 0.99691')
...
pl.plot(RES[:,4], '-k', label='Cancer Cells with vaccination of 0.99692')
...
pl.plot(RES[:,4], '-y', label='Cancer Cells with vaccination of 1')
pl.legend(loc=0)
#pl.title('Program_2_1.py')
pl.xlabel('Time (days)')
pl.ylabel('Cancer Cells (C)')
pl.show()