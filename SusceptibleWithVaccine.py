...
pl.subplot(111)
pl.plot(RES[:,0], '-g', label='Susceptible Cells with vaccination of 0.2')
...
pl.plot(RES[:,0], '-r', label='Susceptible Cells with vaccination of 0.4')
...
pl.plot(RES[:,0], '-b', label='Susceptible Cells with vaccination of 0.6')
...
pl.plot(RES[:,0], '-k', label='Susceptible Cells with vaccination of 0.8')
...
pl.plot(RES[:,0], '-y', label='Susceptible Cells with vaccination of 1')
pl.legend(loc=0)
#pl.title('Program_2_1.py')
pl.xlabel('Time (days)')
pl.ylabel('Susceptible Cells (S)')
pl.show()