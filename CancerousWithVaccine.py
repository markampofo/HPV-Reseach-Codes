...
pl.subplot(111)
pl.plot(RES[:,4], '-g', label='Cancer Cells with vaccination of 0.2')
...
pl.plot(RES[:,4], '-r', label='Cancer Cells with vaccination of 0.4')
...
pl.plot(RES[:,4], '-b', label='Cancer Cells with vaccination of 0.6')
...
pl.plot(RES[:,4], '-k', label='Cancer Cells with vaccination of 0.8')
