...
pl.subplot(111)
pl.plot(RES[:,1], '-g', label='Infected Cells with vaccination of 0.2')
...
pl.plot(RES[:,1], '-r', label='Infected Cells with vaccination of 0.4')
...
pl.plot(RES[:,1], '-b', label='Infected Cells with vaccination of 0.6')
...
pl.plot(RES[:,1], '-k', label='Infected Cells with vaccination of 0.8')
...
pl.plot(RES[:,1], '-y', label='Infected Cells with vaccination of 1')
pl.legend(loc=0)
#pl.title('Program_2_1.py')
pl.xlabel('Time (days)')
pl.ylabel('Infected Cells (I)')
pl.show()